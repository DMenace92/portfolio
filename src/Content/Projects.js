    ...
    return(
        <div className={styles.ProjectMainContainer}>
            <div className={styles.ProjectBanner}>
                ...
                <h1 className={styles.ProjectTextArea}>
                Projects
                </h1>
                </div>
            </div>
            <div className={styles.MainImageHolderContainer}>
                <div className ={styles.projectImageHolderTest}>
                    <button className={styles.navigationImageButton}><img src={arrow}></img></button>
                    <div className ={styles.projectImageHolder}>
                        {/* carrocell */}
                    </div>
                    <button className={styles.navigationImageButton}><img className={styles.arrowIconDesign} src={arrow}></img></button>
